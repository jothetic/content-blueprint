...
const TestimonialsSection: React.FC<TestimonialsSectionProps> = ({ isLoading }) => {
  ...
  return (
    <section 
      ...
      className="py-16 md:py-24 px-4 md:px-6 lg:px-8 bg-neutral-bg pb-24"
    ...
    >
      <div className="max-w-7xl mx-auto">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-4xl font-bold text-center mb-8 md:mb-12 text-headline-text"
          style={{ touchAction: "auto" }}
        >
        ...
        <div className="max-w-3xl mx-auto mb-8 md:mb-16">
          ...
          >
            ...
            <div className="flex justify-center mt-4 gap-2 md:gap-4">
              <CarouselPrevious className="static transform-none bg-primary-blue text-white hover:bg-primary-blue/90 border border-primary-blue/20" />
              <CarouselNext className="static transform-none bg-primary-blue text-white hover:bg-primary-blue/90 border border-primary-blue/20" />
            </div>
          </Carousel>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <h3 className="text-lg md:text-2xl font-semibold mb-4 md:mb-6 text-center text-headline-text">
